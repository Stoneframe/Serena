...
public class SerenaTest
{
    ...
    {
        SimpleEffortTracker effortTracker = (SimpleEffortTracker)serena.getEffortTracker();
    ...
    private void removeChore(String description)
    {
        ...
        serena.removeChore(chore);
    }

    @NonNull
    private Chore getChore(String description)
    {
        Optional<Chore> choreOptional = serena.getAllChores()
            .stream()
    ...
    {
        Optional<Task> taskOptional = serena.getAllTasks(true)
            .stream()
    ...
    {
        Optional<Routine> routineOptional = serena.getAllRoutines()
            .stream()
    ...
    private void assertAllChoresEquals(String... descriptions)
    {
        ...
        List<String> actualDescriptions = serena.getAllChores()
            .stream()
    ...
    private void assertTodaysChoresEquals(String... descriptions)
    {
        ...
        List<String> actualDescriptions = serena.getTodaysChores()
            .stream()
            .map(Chore::getDescription)
            .collect(Collectors.toList());
    ...
    {
        assertEquals(expectedRemainingEffort, serena.getRemainingEffort());
    }
    ...
    private void assertAllTasksEquals(boolean includeCompleted, String... descriptions)
    {
        ...
        List<String> actualDescriptions = serena.getAllTasks(includeCompleted)
            .stream()
    ...
    private void assertTodaysTasksEquals(String... descriptions)
    {
        ...
        List<String> actualDescriptions = serena.getTodaysTasks()
            .stream()
            .map(Task::getDescription)
            .collect(Collectors.toList());
    ...
    private void assertAllRoutinesEquals(String... names)
    {
        ...
        List<String> actualNames = serena.getAllRoutines()
            .stream()
            .map(Routine::getName)
            .collect(Collectors.toList());
