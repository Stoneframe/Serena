...
public class RoutineTest
{
    ...
    @Test
    public void getNextProcedure_nextProcedureIsInTheFuture_returnNextProcedure()
    {
        // ARRANGE
        Routine routine = new Routine("routine", new LocalTime(0));
        ...
        // ACT
        Procedure nextProcedure = routine.getNextProcedure(new LocalTime(12, 0));
    ...
    @Test
    public void getNextProcedure_procedureIsInThePast_returnNull()
    {
        // ARRANGE
        Routine routine = new Routine("routine", new LocalTime(0));
